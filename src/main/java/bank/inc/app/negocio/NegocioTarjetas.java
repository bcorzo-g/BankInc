...
import bank.inc.app.persistencia.daos.ProductoDAO;
...
public class NegocioTarjetas {
    ...
    //Hacer un método que atraves de etdao consulte todos las tarjetas emitidas y las retorne en una lista , no debe recibir parámetros
    public List<EmisionTarjetasDTO> listaEmisionTarjetas() {

        List<EmisionTarjeta> emisiontarjetas = etdao.findAll();
        List<EmisionTarjetasDTO> listarjetasemitidasdto = new ArrayList();
        for (EmisionTarjeta emisiontarjeta : emisiontarjetas ) {
            
            listarjetasemitidasdto.add(EmisionTarjetasDTO.parseEmisiontarjeta(emisiontarjeta));
            
        }
        
        return listarjetasemitidasdto;
    }
    
    //Hacer un método que atraves de pdao consulte todos los productos y los retorne en una lista de productos, no debe recibir parámetros
    public List<ProductoDTO> listaProductos() {
        ...
        for (Producto producto : productos ) {
            ...
            productosdto.add(ProductoDTO.parseProducto(producto));
